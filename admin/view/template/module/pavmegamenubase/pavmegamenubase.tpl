    ...
    <div class="content">
    	 ...
    	 <div id="tab-contents">
    	 	<div id="tab-manage-widgets">
    	 		...
    	 		<div>
    	 			<a class="button btn-action-widget" href="index.php?route=module/pavmegamenubase/addwidget&token=<?php echo $token; ?>" ><?php echo $this->language->get('text_create_widget'); ?></a>
    	 		</div>
    	 		 <table class="form">
    	 		 	<tr>	
    	 		 	...
    	 		 	<tr>
	    	 		 	...
	    	 		 	<td><a class="btn-action-widget" rel="edit" href="index.php?route=module/pavmegamenubase/addwidget&token=<?php echo $token; ?>&id=<?php echo $widget['id'];?>&wtype=<?php echo $widget['type'];?>"><?php echo $this->language->get('text_edit'); ?></a>
	    	 		 		| 
	    	 		 		<a onclick="return confirm('<?php echo $this->language->get('text_confirm_delete');?>');"  rel="edit" href="index.php?route=module/pavmegamenubase/delwidget&token=<?php echo $token; ?>&id=<?php echo $widget['id'];?>&wtype=<?php echo $widget['type'];?>"><?php echo $this->language->get('text_delete'); ?></a>
	    	 		 	</td>
    	 		 	<?php } ?>
    	 		 	</tr>
    	 		 	<?php } ?>
						...
						<div class="megamenu-form">
							...
							<table class="form">
								<tr>
								  ...
								  <td><select name="pavmegamenubase_module[<?php echo $module_row; ?>][layout_id]">
								...
								<tr>
								  ...
								  <td><select name="pavmegamenubase_module[<?php echo $module_row; ?>][position]">
								...
								<tr>
								  ...
								  <td><select name="pavmegamenubase_module[<?php echo $module_row; ?>][status]">
								...
								<tr>
								  ...
								  <td><input type="text" name="pavmegamenubase_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
								</tr>
							...
							<div id="megamenu-form">
								<?php require( "pavmegamenubase_form.tpl" );?>
							</div>
