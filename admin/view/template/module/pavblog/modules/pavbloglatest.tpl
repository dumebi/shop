    ...
    <div id="<?php echo $module_key; ?>">
        ...
        <div id="tab-module-<?php echo $module_key; ?>-<?php echo $module_row; ?>" class="vtabs-content">
          ...
          <table class="form">
          	<tr>
				<td>
				<?php echo $this->language->get("entry_prefixclass");?>
				</td>
				<td>
				  <input type="text" name="pavbloglatest_module[<?php echo $module_row; ?>][prefixclass]" value="<?php echo isset($module['prefixclass'])?$module['prefixclass']:''; ?>"/>
				</td>
			</tr>
			<tr>
				<td>
...
function addModuleLatest() {	
	...
	//prefix class
		html += '  <tr>';
	html += '      <td><?php echo $this->language->get("entry_prefixclass"); ?></td>';		
	html += '    <td class="left"><input type="text" name="pavbloglatest_module[' + module_row_latest + '][prefixclass]"  ></td>';
		html += '    <tr>';
