...
<link rel="stylesheet" type="text/css" href="<?php echo $siteURL; ?>catalog/view/theme/<?php echo $themeName;?>/stylesheet/paneltool.css" />
								                              ...
								                              <div class="accordion-inner  panel-body  clearfix">
																 ...
																 <?php  if (isset($item['type'])&&$item['type']=="image") { ?>
																  <div class="form-group background-images"> 
																		...
																		<a class="clear-bg label label-success" href="#"><span class="fa fa-gear"></span></a>
								                                   ...
								                                   <div class="form-group">
								                                     ...
								                                     <label><?php echo $item['label']?></label>
								                                  	<select name="customize[<?php echo $group['match'];?>][]" data-match="<?php echo $group['match']?>" type="text" class="input-setting" data-selector="<?php echo $item['selector']?>" data-attrs="<?php echo $item['attrs']?>">
																		...
																		<?php } ?>
																	</select>	<a href="#" class="clear-bg label label-success"><span class="fa fa-gear"></span></a>
								                                  </div>
								                                  ...
								                                  <div class="form-group">
																	<label><?php echo $item['label']?></label>
																	<input value="" size="10" name="customize[<?php echo $group['match']?>][]" data-match="<?php echo $group['match']?>" type="text" class="input-setting" data-selector="<?php echo $item['selector']?>" data-attrs="<?php echo $item['attrs']?>"><a href="#" class="clear-bg label label-success"><span class="fa fa-gear"></span></a>
																  </div>
								                                  <?php } ?>
