	  				 ...
	  				 <div id="my-tab-pageslayout" class="vtabs">
	  					<a href="#tab-pcategory" onclick="return false;"><i class="fa fa-wrench"></i> <?php echo $this->language->get('text_category_listing_page');?></a>
	  					<a href="#tab-pproduct" onclick="return false;"><i class="fa fa-wrench"></i> <?php echo $this->language->get('text_product_page');?></a>
	  					<a href="#tab-pcontact" onclick="return false;"><i class="fa fa-wrench"></i> <?php echo $this->language->get('text_contact_page');?></a>
	  				 </div> 
