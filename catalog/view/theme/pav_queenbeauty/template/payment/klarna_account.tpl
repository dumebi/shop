  ...
  <div class="content">
    <table class="form">
      ...
      <tr>
        ...
        <td><select name="pno_day" class="form-control">
      ...
      <tr>
        ...
        <td><input type="text" name="pno" value="" class="form-control" /></td>
      </tr>
      <?php } ?>
      ...
      <tr>
        ...
        <td><input type="text" name="street" value="<?php echo $street; ?>" class="form-control" /></td>
      </tr>
      <tr>
        <td><?php echo $entry_house_no; ?></td>
        <td><input type="text" name="house_no" value="<?php echo $street_number; ?>" class="form-control" /></td>
      </tr>
      <?php } ?>
      <?php if ($iso_code_3 == 'NLD') { ?>
      <tr>
        <td><?php echo $entry_house_ext; ?></td>
        <td><input type="text" name="house_ext" value="<?php echo $street_extension; ?>" class="form-control" /></td>
      </tr>
      <?php } ?>
      <tr>
        <td><?php echo $entry_phone_no; ?></td>
        <td><input type="text" name="phone_no" value="<?php echo $phone_number; ?>" class="form-control" /></td>
      </tr>
