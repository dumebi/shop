    ...
    <?php } else { ?>
        <div class="cart-module">
            <div id="shipping" class="content" style="display: block;">
                <form action="<?php echo $action_shipping; ?>" method="post" id="shipping_form" role="form">
                    <table class="radio">
...
<?php } ?>
    ...
    <div class="buttons clearfix">
        <div class="right"><a href="<?php echo $action_confirm; ?>" class="button btn btn-default"><?php echo $button_confirm; ?></a></div>
    </div>
