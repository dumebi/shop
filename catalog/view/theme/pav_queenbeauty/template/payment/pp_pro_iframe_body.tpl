<html>
    ...
    <body>
        ...
        <?php if (!$error_connection) { ?>
            ...
            <form action="<?php echo $url; ?>" method="post" name="ppform" id="ppform" role="form">
                <input type="hidden" name="cmd" value="_s-xclick">
                <input type="hidden" name="hosted_button_id" value="<?php echo $code; ?>">
                <p style="text-align:center;">
                    <input type="image" src="<?php echo HTTPS_SERVER . 'catalog/view/theme/'.$this->config->get('config_template').'/image/loading.gif'; ?>" border="0" name="submit" alt="Loading.." style="margin-left:auto; margin-right:auto;" />
