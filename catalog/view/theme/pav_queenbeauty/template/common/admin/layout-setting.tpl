...
<div class="theme-layout clearfix">
		...
		<div class="masstop  edit-container clearfix"  data-position="mass_top">
			<div class="pos">Masstop</div>
			<?php if( isset($layout_modules['mass_top']) ){  
				foreach( $layout_modules['mass_top'] as $modulepos ) {
			?>
			<div class="module-pos <?php if( !$modulepos['status']){ ?>mod-disable<?php } ?>" data-position="mass_top" data-id="<?php echo $modulepos['code']."-".$modulepos['index'];?>">
				<div class="edit-module">
					<a target="_blank" href="<?php echo $this->url->link('module/'.$modulepos['code'],'token='.$token);?>"><b><?php echo $modulepos['title']; ?></b></a><i>[[index:<?php echo $modulepos['index'];?>]</i>
				</div>
			</div>
        ...
        <div class="masscenter  edit-container clearfix"  data-position="mass_center">
            <div class="pos">Masscenter</div>
            <?php if( isset($layout_modules['mass_center']) ){
                        foreach( $layout_modules['mass_center'] as $modulepos ) {
                    ?>
            <div class="module-pos <?php if( !$modulepos['status']){ ?>mod-disable<?php } ?>" data-position="mass_center" data-id="<?php echo $modulepos['code']."-".$modulepos['index'];?>">
            <div class="edit-module">
                <a target="_blank" href="<?php echo $this->url->link('module/'.$modulepos['code'],'token='.$token);?>"><b><?php echo $modulepos['title']; ?></b></a><i>[[index:<?php echo $modulepos['index'];?>]</i>
            </div>
        </div>
